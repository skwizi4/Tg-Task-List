...
func (a *App) InitHandlers() {
	a.UserHandler = userHandler.New(a.OnlineUsers, a.ErrChan, a.GoogleSheetsApi, a.ChatGpt, a.Mongo,
	...
	a.taskHandler = taskHandler.New(a.bot, a.ErrChan, a.GoogleSheetsApi, a.logger,
		...
		&a.ProcessingChangingStatusTasks, &a.ProcessingRenamingTasks, a.OnlineUsers)
	a.tgHandler = tg_handlers.New(a.bot, a.UserHandler, a.taskHandler, a.logger, a.ErrChan, a.OnlineUsers, &a.ProcessingRenamingTasks, &a.ProcessingChangingDescriptionTasks,
		&a.ProcessingChangingDataTasks, &a.ProcessingChangingStatusTasks, a.GoogleSheetsApi, &a.ProcessingAddingTasks, a.redis, a.Mongo, &a.ProcessingRegistrationUsers)
...
func (a *App) InitMongo() {
	var err error
	a.Mongo, err = MongoDB.InitMongo(a.config.Mongo.Uri, a.config.Mongo.DataBaseName, a.config.Mongo.CollectionName)
	if err != nil {
...
func (a *App) InitCache() {
	a.OnlineUsers = ActiveUsers.InitRedisCache(a.config.Redis.Password, a.config.Redis.DB, a.config.Redis.Addr)
	a.logger.InfoFrmt("InitCache-Successfully")
}
